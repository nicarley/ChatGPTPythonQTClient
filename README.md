...
Useful Notes:
1.  Make sure you have installed the libraries imported at the top of the list of the Main Chat Window File. Python 3.12 and QT6 are the environments tested in.  Have not tested other environments. 
